...
const revenueData: { date: string; Shopify: number; TikTok: number; Shopee: number; Lazada: number; Amazon: number }[] = [];

const platformDistribution: { name: string; value: number; color: string }[] = [];

const ordersByStatus: { status: string; count: number }[] = [];

const recentOrders: { id: string; platform: string; customer: string; total: number; status: string; time: string }[] = [];

const lowStockItems: { name: string; sku: string; stock: number; reorder: number }[] = [];
    ...
    <div>
      ...
      <div className="p-8 fade-in">
        ...
        <div className="grid grid-cols-4 gap-5 mb-8">
          <StatCard title="Total Revenue (MYR)" value="RM 0" sub="vs last week" />
          <StatCard title="Total Orders" value="0" sub="Across all channels" />
          <StatCard title="Active Products" value="0" sub="In 0 channels" />
          <StatCard title="Low Stock Alerts" value="0" sub="Need reorder" />
        </div>
