...
function downloadInvoice(customer: CustomerType) {
...
export default function CustomersPage() {
  ...
  return (
    <div>
      <TopBar
        title="Customers"
        subtitle={`${pagination.total || customers.length} registered customers`}
        actions={
          ...
          <>
            ...
            <div className="grid grid-cols-4 gap-4 mb-6">
              <div className="erp-card">
                ...
                <div className="text-3xl font-bold">{pagination.total || customers.length}</div>
              </div>
              <div className="erp-card">
              ...
              <div className="erp-card">
                ...
                <div className="text-3xl font-bold" style={{ color: "#7c3aed" }}>
                  {customers.filter((c) => c.totalSpent >= 3000).length}
                </div>
              </div>
            </div>
